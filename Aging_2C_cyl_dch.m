...
xlabel(ax1, 'Dicharging capacity [Ah]', 'FontSize', xLabelFontSize);
...
xlabel(ax2, 'Dicharging capacity [Ah]', 'FontSize', xLabelFontSize);
...
xlabel(ax3, 'Dicharging capacity [Ah]', 'FontSize', xLabelFontSize);
...
xlabel(ax4, 'Dicharging capacity [Ah]', 'FontSize', xLabelFontSize);
