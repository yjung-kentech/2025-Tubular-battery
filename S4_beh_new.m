...
% (1) E_lp 등고선 표현
contourf(D_in_vec, C_rate_vec, data.Elp_min, ...
...
h = colorbar;
ylabel(h, 'η_{n} [V]', 'FontSize', 26);
h.Label.Position(1) = h.Label.Position(1) - 0.5;
...
lgd = legend(hElp, 'η_{n} = 0 V', 'Location', 'northwest', 'FontSize', 25);
...
%% 8. 이미지 저장 -----------------------------------------------------------
exportgraphics(gcf, 'C:\Users\user\Desktop\Figure\Supple Figure\png 파일\S4_h.png', 'Resolution', 300);
