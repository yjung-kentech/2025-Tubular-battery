...
mat_filepath = 'C:\Users\user\Desktop\새figure\mat 파일\Cost_Master.mat';
...
load(fullfile(data_dir, 'Tubular_Sweep_Crate_Rin_60_.mat')); data_60 = data;
...
exportgraphics(gcf, fullfile(figure_save_dir,'figure4f.png'), 'Resolution',300);
