...
%% 폴더 경로 설정
data_load_path = 'C:\Users\user\Desktop\새figure\mat 파일';
...
%% 그래프 설정
legend(legend_handles, legend_labels, 'Location', 'southeast', 'FontSize', 13, 'NumColumns', 2, 'Orientation', 'horizontal');
...
exportgraphics(gcf, 'C:\Users\user\Desktop\새figure\png\figure6f.png', 'Resolution', 300);
