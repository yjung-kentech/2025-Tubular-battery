...
% Load saved data
dataFile = 'C:\Users\user\Desktop\새figure\mat 파일\figure6e.mat';
load(dataFile, 'data');
...
legend([h1, h2, h3, h4], {'T_{out\_bottom}', 'T_{out\_side}', 'P_{in\_top}', 'P_{in\_side}'}, ...
    'Location', 'northwest', 'NumColumns', 2, 'FontSize', 16);
grid off;
box on;
hold off;
...
exportgraphics(gcf, 'C:\Users\user\Desktop\새figure\png\figure6e_new.png', 'Resolution', 300);
